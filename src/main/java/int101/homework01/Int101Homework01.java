...
import int101.homework01.work03.*;
import int101.homework01.work04.*;
...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
      ...
      */
      ...
      double myBMI = myUtil.calculateBMI(65.0, 1.74);;
      System.out.println(myBMI);

      double myAVG = myUtil.average(1, 2, 3);
   ...
   static void work04UseOfObjectClass() {
      ...
      */
       ...
       bank1.deposit(9000);
       bank1.withdraw(1000);
       System.out.println("account owner is "+bank1.getOwner());
       System.out.println("balance "+bank1.getBalance());
       bank2.deposit(6000);
       bank2.withdraw(900);
       System.out.println("account owner is "+bank2.getOwner());
       System.out.println("balance "+bank2.getBalance());
       bank1.transfer(3500, bank2);
       System.out.println(bank1.toString()+"transfer to "+bank2.toString()+"amount 3500");
       System.out.println("account owner is "+bank1.getOwner());
       System.out.println("balance "+bank1.getBalance());
       System.out.println("account owner is "+bank2.getOwner());
       System.out.println("balance "+bank2.getBalance());
